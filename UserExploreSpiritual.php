    ...
    <?php if ($result->num_rows > 0): ?>
        ...
        <div class="col">
            <div class="card" style="width: 18rem;">
                <img src="<?php echo $row['coverimage']; ?>" class="card-img-top" alt="<?php echo $row['bookname']; ?>" style="object-fit: fill; height: 24rem;">
                <div class="card-body">
                    ...
                    <p>
                        ...
                        <!-- TTS Icon (Read PDF Content) -->
                        <button onclick="readPDFContent('<?php echo $row['pdffile']; ?>')">
...
let utterance;  // Global variable to store the speech utterance

// Function to read the content of the PDF and perform TTS
function readPDFContent(pdfUrl) {
    ...
    loadingTask.promise.then(pdf => {
        let totalText = "";  // To store the extracted text
            ...
            pagePromises.push(
                pdf.getPage(i).then(page => {
                    return page.getTextContent().then(textContent => {
                        ...
                        totalText += pageText + " ";  // Append page text to the total
                    });
                })
            );
        }
        ...
        Promise.all(pagePromises).then(() => {
            if (totalText.length > 0) {
                utterance = new SpeechSynthesisUtterance(totalText);  // Create new utterance for text
                utterance.lang = 'en-US';  // Read in English-US
...
// Function to stop the speech utterance
function stopSpeech() {
